...
#
#     irun -nbasync -gui -snload top_feature_behave_testcase1.e emc_top_tb.v /home/student/EMC08/digital_A/top/design/rtl_v/emc_top.v -access rwc -timescale 1ns/10ps -snprerun {set check WARNING; test} -input restore2.tcl +mpssession+SPECMAN25038 -input /home/student/EMC08/digital_A/top/verification/testbench/restore5.tcl
#
...
probe -create -database waves emc_top_tb.EMC_TOP_INSTANCE.CORE_INSTANCE.fsm.fsm_pc_i

simvision -input /home/student/EMC08/digital_A/top/verification/testbench/restore5.tcl.svcf
