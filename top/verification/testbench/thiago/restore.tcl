...
#
#     irun -nbasync -gui -snload top_feature_serial_testcase3.e emc_top_tb.v /home/student/EMC08/digital_A/top/design/rtl_v/emc_top.v -access r -timescale 1ns/10ps -snprerun {set check WARNING} -input restore.tcl +mpssession+SPECMAN19329
#
...
probe -create -database waves emc_top_tb.EMC_TOP_INSTANCE.SERIAL_INSTANCE.serial_data_sbuf_o emc_top_tb.EMC_TOP_INSTANCE.CORE_INSTANCE.reg_ctrl.reg_ctrl_serial_sbuf_rx_i
probe -create -database waves emc_top_tb.EMC_TOP_INSTANCE.SERIAL_INSTANCE.serial_rx_block.serial_rx_input_shifter_reg.serial_end_bit_o
probe -create -database waves emc_top_tb.EMC_TOP_INSTANCE.SERIAL_INSTANCE.serial_rx_block.LOAD_SBUF

simvision -input /home/student/EMC08/digital_A/top/verification/testbench/thiago/restore.tcl.svcf
