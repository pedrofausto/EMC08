...
set_attribute lib_search_path {                       \
   ...
   /home/student/EMC08/common_blocks/ROM/ROM4096X8    \
   /home/student/EMC08/common_blocks/SRAM/SPRAM128X8  \
} / 
...
## Library setup
###############################################################
set LIBERTY_LIBRARIES {
   D_CELLS_JI_MOSLP_slow_1_62V_125C.lib \
   ROM4096X8_slow_1_62V_125C.lib \
   SPRAM128X8_slow_1_62V_125C.lib
}

set_attribute library $LIBERTY_LIBRARIES
##set_attribute lef_library $LEF_LIBRARIES /
##set_attribute cap_table_file $CAP_TABLE_LIBRARIES /
...
report sequential -hier > $_REPORTS_PATH/${DESIGN}_sequential.rpt
report timing > $_REPORTS_PATH/${DESIGN}_timing.rpt
write_hdl  > ${_OUTPUTS_PATH}/${DESIGN}_m.v
##write_encounter design core -basename ${_OUTPUTS_PATH}/encounter/core -lef $LEF_LIBRARIES
