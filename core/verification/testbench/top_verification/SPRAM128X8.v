...
primitive SPRAM128X8_DFF  (Q, D, C, RN, SN, NOTIFY);
...
module SPRAM128X8 (Q, D, ADR, CLK, ENB, WEB, OEB, ramvdd, ramgnd);

output [7:0]	Q;		// RAM data output

input  [7:0]	D;		// RAM data input bus
input  [6:0]	ADR;		// RAM address bus
input		CLK; 		// RAM clock
...
parameter ram_init_file = "/home/student/EMC08/digital_A/core/verification/testbench/top_verification/SPRAM128X8.bin";
...
SPRAM128X8_DFF CHK_ADR (T_OK_ADR, supply_OK, CLK_, 1'b1, 1'b1, NOTIFY_ADR);

SPRAM128X8_DFF CHK_Q (T_OK_QI, supply_OK, CLK_, 1'b1, 1'b1, NOTIFY_REG);

SPRAM128X8_DFF CHK_WEB (RWL, RW, CLK_, 1'b1, 1'b1, NOTIFY_WEB);
