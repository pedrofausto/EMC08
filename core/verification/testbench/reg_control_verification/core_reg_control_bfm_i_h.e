...
// -----------------------------------------------------------------------------
// File Name : core_reg_control_bfm_i_h.e
...
// -----------------------------------------------------------------------------
// Keywords: core_reg_control - core register control, phy - physical, 
...
unit core_reg_control_bfm_i_u like core_reg_control_phy_u {
   ...
   get_pkt(): core_reg_control_signal_type @clock_e is {};

   // method to advise that the send task was done
   its_done() is {};

   // send the signals (packet) to the DUT
   send_pkt(in_pkt: core_reg_control_signal_type) @clock_e is{};
