...
// -----------------------------------------------------------------------------
// Keywords: core_fsm - core finite state machine, phy - physical, 
...
unit core_fsm_bfm_i_u like core_fsm_phy_u {
   ...
   get_pkt(): core_fsm_signal_type @clock_e is {};

   // method to advise that the send task was done
   its_done() is {};

   // send the signals (packet) to the DUT
   send_pkt(in_pkt: core_fsm_signal_type) @clock_e is{};
