...
// ----------------------------------------------------------------------
function integer byte_log_to_phy;
   input [7:0] logical_addr;
   integer physical_addr;
   begin
      case(logical_addr)
...
// ----------------------------------------------------------------------
function integer bit_log_to_phy;
   input [7:0] logical_addr;
   integer physical_addr;
   begin
      case(logical_addr)
...
function integer log_bit_to_phy_byte;
   input [7:0] logical_addr;
   integer physical_addr;
   begin
      case(logical_addr)
         ...
         `IP_PX0,`IP_PT0,`IP_PX1,`IP_PT1,`IP_PS,`IP_PT2,`IP_PTXRX:                              physical_addr=`IP_PHY;
         ...
         `PSW_P,`PSW_OV,`PSW_RS0,`PSW_RS1,`PSW_F0,`PSW_AC,`PSW_CY:                              physical_addr=`PSW_PHY;
         `TCON2_EDGSEL,`TCON2_DFSEL,`TCON2_DFP0,`TCON2_DFP1,`TCON2_DFP2,`TCON2_TF2,`TCON2_TR2:  physical_addr=`TCON2_PHY;
