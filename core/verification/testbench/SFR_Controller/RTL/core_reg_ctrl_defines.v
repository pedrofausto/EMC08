...
`define ACRL_MASK          8'b00000000

`define ACRM               8'h85
`define ACRM_PHY           6'd05
`define ACRM_MASK          8'b00000000

`define ACRH               8'h86
`define ACRH_PHY           6'd06
`define ACRH_MASK          8'b00000000
...
`define TL0_MASK           8'b00000000

`define TL1                8'h8B
`define TL1_PHY            6'd11
`define TL1_MASK           8'b00000000

`define TH0                8'h8C
`define TH0_PHY            6'd12
`define TH0_MASK           8'b00000000

`define TH1                8'h8D
`define TH1_PHY            6'd13
`define TH1_MASK           8'b00000000

`define TM0                8'h8E
`define TM0_PHY            6'd14
`define TM0_MASK           8'b00000000

`define TM1                8'h8F
`define TM1_PHY            6'd15
`define TM1_MASK           8'b00000000
...
`define TACPH              8'hBB
`define TACPH_PHY          6'd27
`define TACPH_MASK         8'b00000011
