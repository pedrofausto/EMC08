...
extend tmr2_mon_u {
  ...
  keep sel_feat == FEAT_1        ;
  
  cover cover_func_model is  also {
  
     item feature_f1_cov : feature_f1_t = feature_f1 using illegal = (feature_f1_cov == RESET_ERROR);
...
extend MAIN tmr2_seq_s {
   ...
   body() @driver.clock is only {
      ...
      out ("TEST DESCRIPTION = RESET CHECK   FEATURE NUMBER = 00  STARTS HERE ...\n");
...
//    do seq_down_count_ext;
 ...
 //           do seq_div_128      ;
         ...
         case {
            ...
            num_pkt == 13 { do seq_tacp_h       };
            num_pkt == 14 { do seq_tacp_l       };
