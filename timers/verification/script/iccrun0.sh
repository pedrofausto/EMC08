...
irun -nbasync -gui -access rwc /home/student/EMC08/digital_A/timers/verification/testbench/tmr0_test.e /home/student/EMC08/digital_A/timers/design/rtl_v/top_timers.v  /home/student/EMC08/digital_A/timers/verification/testbench/tmr0_tb.v -coverage all -covtest tmr0_cov_test -input "@source restore_timer0_1.tcl" -run 


#irun -gui -snload tmr2_test_f1.e ./rtl_t2/*.v -access r -snprerun "wave event; set check WARNING; test" -sv -coverage all -covtest tmr2_cov_test -input "@source restore_timer0_1.tcl" #-covoverwrite
