...
extend int_mon_u {
   ...
   keep feature == FEATURE_F2_V1;
   
   cover cover_func_model using text = "Coverage using functional model" is {
      item feature_f2_v1_cov:feature_f2_v1_t = feature_f2_v1  using illegal = (
                                     (feature_f2_v1_cov == INT_TXRX_ERROR)  or
                                     (feature_f2_v1_cov == INT_TF2_ERROR)   or
                                     (feature_f2_v1_cov == INT_RI_TI_ERROR) or
                                     (feature_f2_v1_cov == INT_TF1_ERROR)   or
                                     (feature_f2_v1_cov == INT_IE1_ERROR)   or
                                     (feature_f2_v1_cov == INT_TF0_ERROR)   or
                                     (feature_f2_v1_cov == INT_IE0_ERROR)   or
                                     (feature_f2_v1_cov == INT_NONE_ERROR)    );
   }; // end cover
